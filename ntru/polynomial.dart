...
class Polynomial {
  ...
  Polynomial addPolyModInt(Polynomial b, int mod) {
    ...
    for (int i = 0; i < this.N; i++) c.coefficients[i] = (this.coefficients[i] + b.coefficients[i]) % mod;
    return c;
  }
  ...
  Polynomial addPolyModPowerOfTwo(Polynomial b, int mod) {
    Polynomial c = Polynomial.fromDegree(this.N, d: 0, coeff: 0);
    for (int i = 0; i < this.N; i++) c.coefficients[i] = (this.coefficients[i] + b.coefficients[i]) & (mod - 1);
    return c;
  }
