...
class Kyber {
  ...
  KyberDigest decrypt(List<int> cipherText, List<int> privateKey) {
    ...
    // Sesuaikan ukuran berdasarkan level
    switch (_level) {
    ...
    if (privateKey.length < end4) {
      throw Exception("privateKey tidak cukup panjang. Diperlukan panjang: $end4, Panjang sekarang: ${privateKey.length}");
    }
